...
!  q is the comoving momentum in units of k_B*T_gamma0/c.
    ...
    call dverk3(EV,this, etat, EV%ScalEqsToPropagate,derivs,tau,y,tauend,tol1,ind,c1,EV%nvar,w)
    if (ind==-3) then
    ...
    ytprimein = 0
    call derivst(EV,this,EV%nvart,tau,ytin,ytprimein)
 ...
 dvisibility(f_i)*polter)
    ...
    subroutine derivst(EV,this,n,tau,ayt,aytprime)
    ...
    if (.not. EV%TensTightCoupling) then
        ...
        if (EV%lmaxt > 2) then
            ...
            !assume after tight coupling ended
                do f_i = 1, num_cmb_freq
                    opac_rayleigh = this%Recombination_rayleigh_eff(a)*State%akthom/a2*(min(1._dl,&
                    freq_factors(f_i,1)/a2**2 + freq_factors(f_i,2)/a2**3  + freq_factors(f_i,3)/a2**4)) 
                    opac_tot=opac_rayleigh+opacity(1)
                    ind = EV%g_ix_freq + (f_i-1)*EV%freq_neq
    ...
    subroutine dverk3 (EV, this, etat, n, fcn, x, y, xend, tol, ind, c, nw, w)
    use Precision
    use MpiUtils
...
100 continue
    ...
    call fcn(EV,this, etat, n, x, y, w(1,1))
...
200 continue
    ...
    call fcn(EV, this, etat, n, x + c(18)/6._dl, w(1,9), w(1,2))
    !
    do 205 k = 1, n
...
205 continue
    ...
    call fcn(EV, this, etat, n, x + c(18)*(4._dl/15._dl), w(1,9), w(1,3))
    !
    do 210 k = 1, n
...
210 continue
    ...
    call fcn(EV, this, etat, n, x + c(18)*(2._dl/3._dl), w(1,9), w(1,4))
    !
    do 215 k = 1, n
...
215 continue
    call fcn(EV, this, etat, n, x + c(18)*(5._dl/6._dl), w(1,9), w(1,5))
    !
    do 220 k = 1, n
...
220 continue
    call fcn(EV, this, etat, n, x + c(18), w(1,9), w(1,6))
    !
    do 225 k = 1, n
...
225 continue
    call fcn(EV, this, etat, n, x + c(18)/15._dl, w(1,9), w(1,7))
    !
    do 230 k = 1, n
...
230 continue
    ...
    call fcn(EV, this, etat, n, x + c(18), w(1,9), w(1,8))
    !
