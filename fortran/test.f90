    ...
    type, extends(TQuintessence) :: TEarlyQuintessence
        ...
        !real(dl) :: theta_i = 3.1_dl !initial value of phi/ffth
        ...
        real(dl) :: f =0.05 ! sqrt(8*pi*G)*f
        real(dl) :: m = 5d-54 !m in reduced Planck mass units
        real(dl) :: theta_i = 2.83  !initial value of phi/f
        real(dl) :: frac_lambda0 = 1._dl !fraction of dark energy density that is cosmological constant today
        logical :: use_zc = .true. !adjust m to fit zc
        !real(dl) :: zc, fde_zc !readshift for peak f_de and f_de at that redshift
        real(dl) :: zc = 3647.53
        real(dl) :: fde_zc = 0.122
    ...
    !this%zc = thisIni%Read_Double('zc')
    !this%fde_zc = this%Ini%Read_Double('fde_zc')
    ...
    !this%zc = P%zc
    !this%fde_zc = P%fde_zc
    !write(*,*) 'CP zc and fde_zc : ', P%zc, P%fde_zc
    !write(*,*) 'init this zc and fde_zc : ', this%zc, this%fde_zc
    !write(*,*) 'here0 !'
    ...
    write(*,*) 'has peaaak', this%zc, this%fde_zc
    ...
    !write(*,*) 'Early_Q : ', this%zc, this%fde_zc
